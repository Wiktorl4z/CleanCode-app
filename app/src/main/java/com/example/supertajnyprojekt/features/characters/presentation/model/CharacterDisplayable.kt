...
data class CharacterDisplayable(
    ...
    constructor(character: Character) : this(
        ...
        location = CharacterLastLocationDisplayable(character.characterLastLocation),
        name = character.name,
        originDisplayable = CharacterOriginLocationDisplayable(character.characterOriginLocation),
